...
const getChartDescription = (year) =>
  `This chart models a household with 2 adults (both age 40) and 3 children (ages 7, 5, and 3) in ${formatYearRange(year)}. The primary earner contributes £10,000 annually to their pension. Baseline shows policy without reforms, With Policy shows impact after selected changes.`;

// Legend items for export
const LEGEND_ITEMS = [
  { color: "#9CA3AF", label: "Baseline", type: "line" },
  { color: "#319795", label: "With Policy", type: "line" },
];
      ...
      <div className="chart-header">
        <div>
          ...
          <p className="chart-description">
            ...
            policy without reforms, With Policy shows impact after selected changes.
          </p>
        </div>
        <button
