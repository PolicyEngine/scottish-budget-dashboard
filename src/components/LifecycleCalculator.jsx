...
function LifecycleCalculator() {
  ...
  const renderModalContent = () => {
    ...
    const renderUnearnedIncomeDetail = () => {
      ...
      return renderComparisonTable(allRows, year, null,
        "The Scottish Budget froze higher rate thresholds while lower thresholds are uprated by inflation. This fiscal drag pushes more income into higher tax bands over time.");
    };
      ...
      <div className="lifecycle-header">
        <div className="lifecycle-header-content">
          ...
          <p className="lifecycle-subtitle">
            Model the impact of Scottish Budget policy reforms over your lifetime
          </p>
        </div>
      </div>
