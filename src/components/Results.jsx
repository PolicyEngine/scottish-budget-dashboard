...
function Results({ results, isLoading, selectedPolicies }) {
  ...
  const handleDownloadTxt = () => {
    ...
    let content = `Scottish Budget 2026-27 Dashboard - Analysis Results\n`;
    ...
    link.href = url;
    link.download = `scottish-budget-analysis-${date}.txt`;
  ...
  const handleDownloadCsv = () => {
    ...
    const link = document.createElement("a");
    link.href = url;
    link.download = `scottish-budget-analysis-${date}.csv`;
    document.body.appendChild(link);
    link.click();
    document.body.removeChild(link);
    URL.revokeObjectURL(url);
    ...
    return (
      <div className="results-empty">
        <div className="empty-state">
          <h2>Welcome to the Scottish Budget 2026-27 dashboard</h2>
          <p>
            Analyse the potential impacts of budget policies on Scottish households
            and public finances.
          </p>
    ...
    <div className="results">
      <section className="results-intro">
        ...
        <p className="section-description">
          ...
          policies on Scottish households and public finances. The analysis is powered
          by{" "}
          <a
