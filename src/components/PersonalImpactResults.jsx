  ...
  return (
    <div className="personal-impact-results">
      ...
      <div className="methodology-note">
        ...
        <p>
          This calculation uses PolicyEngine UK to model how each Scottish Budget
          2026-27 policy affects your household&apos;s net income. The model
          accounts for Scottish income tax, National Insurance, benefits, and other taxes
          and transfers. Children are automatically aged each year, and your
          income grows at the specified rate. Results compare the policy
          reform against a baseline scenario.
        </p>
      </div>
    </div>
  );
